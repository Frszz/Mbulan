  ...
  function t(e) {
    1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (n("html").removeAttr("dir"),
        ...
        n("#bootstrap-style").attr("href", "http://localhost/Mbulan/application/assets/css/bootstrap.min.css"),
        n("#app-style").attr("href", "http://localhost/Mbulan/application/assets/css/app.min.css"),
      ...
      : 1 == n("#rtl-mode-switch").prop("checked") &&
        ...
        (n("#light-mode-switch").prop("checked", !1),
        n("#dark-mode-switch").prop("checked", !1),
        n("#bootstrap-style").attr("href", "http://localhost/Mbulan/application/assets/css/bootstrap-rtl.min.css"),
        n("#app-style").attr("href", "http://localhost/Mbulan/application/assets/css/app-rtl.min.css"),
        n("html").attr("dir", "rtl"),
