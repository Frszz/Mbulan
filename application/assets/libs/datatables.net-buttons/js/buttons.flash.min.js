      ...
      if (g.isPlainObject(d)) x(d);
        ...
        if (r) {
          ...
          for (e = c.attributes.length - 1; 0 <= e; e--) {
            ...
            -1 !== f.indexOf(":") && (h.push({ name: f, value: i }), c.removeAttribute(f));
          }
          e = 0;
  ...
  var y = function (a, b) {
    ...
    A = function (a, b) {
      for (
        ...
        m.push(k(c.body[p]));
      return { str: l + m.join(d) + o, rows: m.length };
    },
    u = {
      available: function () {
        return h.hasFlash();
    ...
    v = "",
    v =
      "undefined" === typeof k.XMLSerializer
        ? new (function () {
    ...
    action: function (a, b, d, c) {
      ...
      var a = c._flash,
        ...
        d = {
          ...
          xl: { _rels: { "workbook.xml.rels": g.parseXML(n["xl/_rels/workbook.xml.rels"]) }, "workbook.xml": g.parseXML(n["xl/workbook.xml"]), "styles.xml": g.parseXML(n["xl/styles.xml"]), worksheets: { "sheet1.xml": f } },
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            i ||
              ("number" === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                ? (i = o(f, "c", { attr: { t: "n", r: j }, children: [o(f, "v", { text: a[b] })] }))
                : ((n = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")), (i = o(f, "c", { attr: { t: "inlineStr", r: j }, children: { row: o(f, "is", { children: { row: o(f, "t", { text: n }) } }) } }))));
            l.appendChild(i);
          }
          h.appendChild(l);
          e++;
      ...
      for (var s = 0, r = i.body.length; s < r; s++) j(i.body[s], e);
