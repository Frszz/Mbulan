(function (j) {
  "function" === typeof define && define.amd
    ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (f) {
    ...
    j.each(b, function (b, c) {
      if (j.isPlainObject(c)) {
        ...
        if (s) {
          ...
          g = 0;
          for (w = i.length; g < w; g++) (f = c.createAttribute(i[g].name.replace(":", "_dt_b_namespace_token_"))), (f.value = i[g].value), e.setAttributeNode(f);
        }
    ...
    action: function (a, b, d, c) {
      ...
      var e = this,
        ...
        a = {
          ...
          xl: { _rels: { "workbook.xml.rels": a("xl/_rels/workbook.xml.rels") }, "workbook.xml": a("xl/workbook.xml"), "styles.xml": a("xl/styles.xml"), worksheets: { "sheet1.xml": i } },
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            f ||
              ("number" === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                ? (f = n(i, "c", { attr: { t: "n", r: e }, children: [n(i, "v", { text: a[b] })] }))
                : ((h = !h.replace ? h : h.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")),
                  (f = n(i, "c", { attr: { t: "inlineStr", r: e }, children: { row: n(i, "is", { children: { row: n(i, "t", { text: h, attr: { "xml:space": "preserve" } }) } }) } }))));
            r.appendChild(f);
          }
          l.appendChild(r);
          g++;
      ...
      c.autoFilter &&
        (j("mergeCells", i).before(n(i, "autoFilter", { attr: { ref: "A" + d + ":" + x(k.header.length - 1) + h } })),
