...
(function (e) {
  ...
  e.extend(l.prototype, {
    ...
    add: function (a, b) {
      ...
      if ("string" === typeof b) {
        for (var d = b.split("-"), e = this.s, c = 0, f = d.length - 1; c < f; c++) e = e.buttons[1 * d[c]];
        c = e.buttons;
        b = 1 * d[d.length - 1];
      }
    ...
    _expandButton: function (a, b, c, d) {
      for (var g = this.s.dt, f = 0, b = !e.isArray(b) ? [b] : b, h = 0, k = b.length; h < k; h++) {
        ...
        if (p)
          if (e.isArray(p)) this._expandButton(a, p, c, d);
            ...
            j &&
              ...
              j.conf.buttons && ((j.collection = e("<" + this.c.dom.collection.tag + "/>")), (j.conf._collection = j.collection), this._expandButton(j.buttons, j.conf.buttons, !0, d)),
              p.init && p.init.call(g.button(j.node), g, e(j.node), p),
              f++);
          }
      }
    },
    ...
    _popover: function (a, b, c) {
      var d = this.c,
        ...
        f = b.node(),
        h = function () {
          u(e(".dt-button-collection"), g.fade, function () {
            e(this).detach();
          });
      ...
      if ("absolute" === d) {
        ...
        c.hasClass(g.rightAlignClassName) || "button-right" === g.align
          ? ((n = i - j), d > p + n && ((d -= p + n), (k -= j + n), (n = d > k ? n + k : n + d)))
          : ((n = d - p), k < j + n && ((d -= p + n), (k -= j + n), (n = d > k ? n + k : n + d)));
  ...
  l.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      g = function (a) {
        if (e.isArray(a)) for (var h = 0, k = a.length; h < k; h++) g(a[h]);
        else "string" === typeof a ? (-1 !== a.indexOf(",") ? g(a.split(",")) : ((a = e.inArray(e.trim(a), d)), -1 !== a && c.push(b[a].inst))) : "number" === typeof a && c.push(b[a].inst);
      };
    g(a);
    return c;
  };
  l.buttonSelector = function (a, b) {
    for (
      var c = [],
        d = function (a, b, c) {
          for (var e, g, f = 0, h = b.length; f < h; f++) if ((e = b[f])) (g = c !== m ? c + f : f + ""), a.push({ node: e.node, name: e.conf.name, idx: g }), e.buttons && d(a, e.buttons, g + "-");
        },
        g = function (a, b) {
          var f,
            h,
  ...
  l.defaults = {
    ...
    dom: {
      ...
      button: { tag: "ActiveXObject" in q ? "a" : "button", className: "dt-button", active: "active", disabled: "disabled" },
