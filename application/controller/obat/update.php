                                ...
                                <form action="" method="">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="kode_obat">
                                            </div>
                                        </div>
                                        <!-- end row -->
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="tgl_masuk">
                                            </div>
                                        </div>
                                        <!-- end row -->

                                        <div class="row mb-3">
                                            <label for="penyakit_obat" class="col-sm-2 col-form-label">Penyakit</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="penyakit_obat">
                                            </div>
                                        </div>
                                        <!-- end row -->
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="date" id="tgl_kadaluwarsa">
                                            </div>
                                        </div>
                                        <!-- end row -->
